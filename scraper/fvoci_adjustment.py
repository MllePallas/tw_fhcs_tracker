...
# 富邦／凱基：「金控稅後淨利加計FVOCI後獲利」（富邦 115/08 起改稱「對保留盈餘影響數」）；
# 國泰：「對保留盈餘影響數」；中信（2891）自 115/08 起揭露金控層級（含當月與累計）。
# 台新新光（2887）目前僅揭露壽險子公司層級，故不在此清單；
# 未來若開始揭露金控層級，把代號加進來即可。
HOLDING_FVOCI_CODES = {"2881", "2882", "2883", "2891"}
